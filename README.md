...
- 🧰 **工具页** — 侧边栏「工具」集中放置文本与文件辅助工具，当前内置繁简转换，后续可继续扩展其它工具。
...
<table>
  ...
  <tr>
    ...
    <td width="50%" align="center">
      ...
      <br/><sub><b>工具 / 设置</b> · 繁简转换、自定义词库与 ffmpeg / AviSynth+ 自检</sub>
    </td>
  </tr>
</table>
...
应用会在系统用户目录下保存配置、窗口状态、繁简转换自定义词库、WebView 缓存、压制临时字幕、LOGO 预览帧和 AVS 临时脚本。完整路径和清理建议见 [用户数据与缓存](docs/CACHE_AND_DATA.md)。
