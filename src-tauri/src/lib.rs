...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::media_tool::list_ts_segments,
            ...
            commands::text_conversion::save_converted_text_to_path,
            commands::tool_config::load_text_conversion_config,
            commands::tool_config::save_text_conversion_config,
            commands::tool_config::load_proofread_config,
            commands::tool_config::save_proofread_config,
            commands::tool_config::load_cc_subtitle_config,
            commands::tool_config::save_cc_subtitle_config,
            commands::proofread::proofread_text,
            commands::proofread::read_proofread_file,
            commands::proofread::save_proofread_file,
            commands::proofread::save_proofread_to_path,
            commands::cc_subtitle::organize_cc_subtitle_text,
            commands::cc_subtitle::read_cc_subtitle_file,
            commands::cc_subtitle::save_cc_subtitle_file,
            commands::cc_subtitle::save_cc_subtitle_to_path,
